...
class OrderListAdapter(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (convertView == null) {
            view = LayoutInflater.from(context).inflate(R.layout.item_home_shop_order, null)
            ...
            holder.tv_orderNumber = view.findViewById(R.id.tv_pay)
        ...
        holder.tv_orderNumber.text = "订单编号：ED2021" + System.currentTimeMillis()
        ...
        view!!.setOnClickListener {
            if (MoreCheckError.isFastClick()) {
                ...
                intent.putExtra("pic", goolist.mainPic)
    ...
    inner class ViewHolder {
        ...
        lateinit var tv_orderNumber: TextView
    }
