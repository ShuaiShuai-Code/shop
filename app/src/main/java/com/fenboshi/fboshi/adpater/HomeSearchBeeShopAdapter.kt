...
class HomeSearchBeeShopAdapter(private val context: Activity, var listItem: List<NineGooldsBean>, var cid: String, var cname: String, var curl: String, var cnumber: String, var pid: String, var phone: String) : BaseAdapter() {
